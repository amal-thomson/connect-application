...
describe('Event Processing Integration Tests', () => {
  ...
  describe('POST /event', () => {
    ...
    it('should skip processing when generateDescription is not enabled', async () => {
      ...
      console.info('🚀 Starting test: should skip processing when generateDescription is not enabled');
